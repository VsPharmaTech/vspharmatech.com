...
const Counter = ({ target }: { target: number }) => {
  ...
  return (
    <span ref={ref} className="text-4xl sm:text-5xl md:text-6xl font-lora font-bold flex items-center">
      {count}
...
//   return (
//     <span ref={ref} className="text-6xl font-lora font-bold flex items-center">
//       {count}
...
// const Statcounter = () => {
//   return (
//     <section className="bg-gradient-to-r from-indigo-500 to-indigo-950 text-white py-8 px-6">
//       <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 text-center">
//         {stats.map((stat, index) => (
//           <div key={index} className="flex flex-col items-center">
//             <p className="text-xl pb-3">{stat.title}</p>
//             <Counter target={stat.target} />
//           </div>
//         ))}
//       </div>
