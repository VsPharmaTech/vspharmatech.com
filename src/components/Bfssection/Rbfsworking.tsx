...
export default function RBfsWorking({
  title,
  heading,
  description,
  videoSrc,
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 md:gap-12 items-center">
        ...
        {/* Content first on mobile, second on larger screens */}
        <motion.div className="text-left md:order-1">
          <motion.span
        ...
        {/* Video second on mobile, first on larger screens */}
        <motion.div
          className="relative rounded-xl overflow-hidden shadow-lg md:order-0"
