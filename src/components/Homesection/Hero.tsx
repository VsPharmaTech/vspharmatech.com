...
export default function Hero() {
  ...
  return (
    ...
    // >
      <div className="relative w-full mb-8 overflow-hidden flex flex-col items-center text-center px-4">

        {/* Preload image via hidden tag */}
      <img
      src="/bg-hero.png"
      ...
      <div className="relative z-10 w-full max-w-5xl pt-12 sm:pt-20 pb-8 sm:pb-12">
        ...
        <div className="text-4xl sm:text-6xl md:text-7xl font-raleway font-bold mb-2 sm:mb-4 bg-white bg-clip-text text-transparent">
          VS PHARMATECH
        </div>
        ...
        <div className="text-base sm:text-xl font-roboto font-normal text-white mb-8">
        ...
        {/* CTA Buttons */}
        <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 mb-12 sm:mb-16 mx-12">
          {/* <motion.div
            initial={{ opacity: 0, scale: 0.8 }}
            animate={{ opacity: 1, scale: 1 }}
